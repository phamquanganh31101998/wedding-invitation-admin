...
import {
  IGuest,
  IGuestCreateRequest,
} from '@/features/guests/services/guest.types';
import { GUEST_ATTENDANCE_OPTIONS } from '@/features/guests/services/guest.constants';
import {
  useCreateGuest,
  useUpdateGuest,
} from '@/features/guests/services/guest.hooks';
...
export default NiceModal.create(
  ({ tenantId, guest, onSuccess }: GuestFormModalProps) => {
            ...
            <Form>
              ...
              <div style={{ marginBottom: '20px' }}>
                ...
                <Select
                  ...
                  style={{ width: '100%' }}
                  status={
                    errors.attendance && touched.attendance ? 'error' : ''
                  }
                  size="large"
                />
